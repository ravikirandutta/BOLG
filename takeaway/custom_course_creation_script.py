...
def load_courses(request):
	...
	if user.is_superuser  and user.is_authenticated()  :
		...
		{ 'course_name':"BUS 653P Operations Strategy",'code':"BUS 632PBUS",'year':"2014",'batch':"2014",'section':"Thursday"},
		{ 'course_name':"BUS 659P Process Analysis & Six Sigma",'code':"BUS 659P",'year':"2014",'batch':"2014",'section':"Tuesday"},
		{ 'course_name':"BUS 661P Applied Entrepreneurship",'code':"BUS 661P",'year':"2014",'batch':"2014",'section':"Tuesday"},
		{ 'course_name':"BUS 680P Illiquid Alternt. Investments",'code':"BUS 680P",'year':"2014",'batch':"2014",'section':"Monday"},
		{ 'course_name':"BUS 685P Private Equity Investing",'code':"BUS 685P",'year':"2014",'batch':"2014",'section':"Wednesday"},
		{ 'course_name':"BUS 688P Real Estate Devpt & Invest",'code':"BUS 688P",'year':"2014",'batch':"2014",'section':"Thursday"},
		{ 'course_name':"BUS 634P Strategic Management",'code':"BUS 1000P",'year':"2014",'batch':"2014",'section':"Thursday"},
		]
		...
		for course in main_courses:
			c_list= Course.objects.filter(course_name=course['course_name'])
			if c_list.count() == 0 :
		...
		for course in courses:
			...
			if c_list.count()  == 0 :
				c = CourseInstance(course= main_course,section = Section.objects.get_or_create(name= course['section'],school=school)[0], program = program, batch = batch,year = year,
