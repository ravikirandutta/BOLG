...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PointEvent'
        db.create_table(u'takeaway_pointevent', (
        ...
        db.send_create_signal(u'takeaway', ['PointEvent'])

        # Adding model 'UserEventLog'
        db.create_table(u'takeaway_usereventlog', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], blank=True)),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['takeaway.PointEvent'], blank=True)),
            ('points', self.gf('django.db.models.fields.IntegerField')(default=5)),
            ('session', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['takeaway.Session'])),
            ('course_instance', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['takeaway.CourseInstance'])),
        ...
        db.send_create_signal(u'takeaway', ['UserEventLog'])


    def backwards(self, orm):
        # Deleting model 'PointEvent'
        db.delete_table(u'takeaway_pointevent')

        # Deleting model 'UserEventLog'
        db.delete_table(u'takeaway_usereventlog')
