...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'takeaway_comment', (
        ...
        db.send_create_signal(u'takeaway', ['Comment'])

        # Adding M2M table for field tags on 'Comment'
        m2m_table_name = db.shorten_name(u'takeaway_comment_tags')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('comment', models.ForeignKey(orm[u'takeaway.comment'], null=False)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'takeaway_comment')

        # Removing M2M table for field tags on 'Comment'
        db.delete_table(db.shorten_name(u'takeaway_comment_tags'))
