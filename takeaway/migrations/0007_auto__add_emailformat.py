...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EmailFormat'
        db.create_table(u'takeaway_emailformat', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('format', self.gf('django.db.models.fields.TextField')()),
            ('school', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['takeaway.School'])),
        ))
        db.send_create_signal(u'takeaway', ['EmailFormat'])


    def backwards(self, orm):
        # Deleting model 'EmailFormat'
        db.delete_table(u'takeaway_emailformat')
