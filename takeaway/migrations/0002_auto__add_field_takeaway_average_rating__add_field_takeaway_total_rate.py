...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TakeAway.average_rating'
        db.add_column(u'takeaway_takeaway', 'average_rating',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'TakeAway.total_raters'
        db.add_column(u'takeaway_takeaway', 'total_raters',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TakeAway.average_rating'
        db.delete_column(u'takeaway_takeaway', 'average_rating')

        # Deleting field 'TakeAway.total_raters'
        db.delete_column(u'takeaway_takeaway', 'total_raters')
