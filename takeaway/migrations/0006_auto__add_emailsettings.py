...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'takeaway_emailsettings', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('mail_when_newuser', self.gf('django.db.models.fields.IntegerField')(default=2)),
            ('mail_when_takeaway', self.gf('django.db.models.fields.IntegerField')(default=2)),
            ('mail_when_rated', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('mail_when_commented', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ...
        db.send_create_signal(u'takeaway', ['EmailSettings'])


    def backwards(self, orm):
        # Deleting model 'EmailSettings'
        db.delete_table(u'takeaway_emailsettings')
