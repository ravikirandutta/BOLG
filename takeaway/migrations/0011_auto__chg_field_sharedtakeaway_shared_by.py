...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SharedTakeaway.shared_by'
        db.alter_column(u'takeaway_sharedtakeaway', 'shared_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['takeaway.TakeAwayProfile']))

    def backwards(self, orm):

        # Changing field 'SharedTakeaway.shared_by'
        db.alter_column(u'takeaway_sharedtakeaway', 'shared_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
    ...
    models = {
        ...
        u'takeaway.sharedtakeaway': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'shared_by': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['takeaway.TakeAwayProfile']", 'blank': 'True'}),
