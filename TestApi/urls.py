...
urlpatterns = patterns('',
    ...
    url(r'^6/',TemplateView.as_view(template_name="landing6.html")),
    url(r'^grocery/',TemplateView.as_view(template_name="grocery.html")),
    url(r'^biryani/',TemplateView.as_view(template_name="homefood.html")),
